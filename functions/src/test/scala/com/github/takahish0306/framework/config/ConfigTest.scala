...
class ConfigTest extends FlatSpec with Eval {
  ...
  "Config.load" should "input from ./functions/src/test/resources/com/github/takahish0306/framework/functions/config/Test.scala" in {
    val filepath = "./functions/src/test/resources/com/github/takahish0306/framework/functions/config/Test.scala"
