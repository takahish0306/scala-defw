...
class ConfigTest extends FlatSpec with Eval {
  ...
  "Config.load" should "input from ./src/test/resources/com/github/takahish0306/framework/config/Test.scala" in {
    val filepath = "./src/test/resources/com/github/takahish0306/framework/config/Test.scala"
